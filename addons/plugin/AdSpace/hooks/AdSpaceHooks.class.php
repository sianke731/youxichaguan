		...
		switch($data['display_type']) {
			...
			case 3:
				...
				for($i = 0; $i < count($_POST['banner']); $i++) {
					//JTee 2014-1-5 加入title 和 description
					$picData[] = array('banner'=>$_POST['banner'][$i], 'bannerurl'=>$_POST['bannerurl'][$i], 'titles'=>$_POST['titles'][$i], 'descriptions'=>$_POST['descriptions'][$i]);
				}
