...
$menu = array(
	...
	//JTee 2013-12-21 替换菜单 start
	'admin_menu_small'	=> array(
				'index'	=> array(
						'首页'	=> array(
								'欢迎页'	=>  U('admin/Home/index'),
								'意见反馈'	=>  U('admin/Index/suggest'),
								'站点配置'	=>  U('admin/Config/site'),
								'积分配置'	=>  U('admin/Global/credit'),
								'邀请配置'	=>  U('admin/Config/invite'),
								'页面管理'	=>  U('pages/Admin/index'),
								'清理缓存'	=>  U('admin/Tool/cleancache'),
						),
			    		'广告管理' => array(
			    			"添加广告"	=>	U('admin/Addons/admin',array("pluginid"=>4,"page"=>'addAdSpace')),
			    			"广告列表"	=>	U('admin/Addons/admin',array("pluginid"=>4,"page"=>'config')),
			    		),
			    		'选项配置' => array(
			    			"城市"	=>	U('admin/SetOption/index',array("type_id"=>1)),
			    			"公司类型"	=>	U('admin/SetOption/index',array("type_id"=>2)),
			    			"职位类型"	=>	U('admin/SetOption/index',array("type_id"=>3)),
			    			"活动类型"	=>	U('admin/SetOption/index',array("type_id"=>4)),
			    			"需求目标"	=>	U('admin/SetOption/index',array("type_id"=>5)),
			    			"合作区域"	=>	U('admin/SetOption/index',array("type_id"=>6)),
			    			"游戏标签"	=>	U('admin/SetOption/tj_tag'),
			    			"程序平台"	=>	U('admin/SetOption/index',array("type_id"=>8)),
			    		),
				),
	),
	//JTee 2013-12-21 替换菜单 end
	'admin_menu'	=> array(
		'index'	=> array(
			'首页'	=> array(
	    ...
	    'extends'		=> array(
	 	...
	 	'company'	=> array(
	 		'公司管理' => array(
	 			"公司管理" => U('company/Admin/index'),
	 		),
	 	),
	 	'game'	=> array(
	 		'产品管理' => array(
	 			"产品列表" => U('game/Admin/index'),
	 		),
	 	),
	 	'event'	=> array(
	 		'活动管理' => array(
	 			"活动列表" => U('event/Admin/eventlist'),
	 			"添加活动" => U('event/Admin/setinfo'),
	 			"活动类型" => U('event/Admin/eventtype'),
	 		),
	 	),
	 	'news'	=> array(
	 		'资讯管理' => array(
	 			"资讯列表" => U('news/Admin/newslist'),
	 			"分类管理" => U('news/Admin/newsCategory'),
	 			"发布信息" => U('news/Admin/setinfo'),
	 		),
	 	),
		'users'	=> array(
				'用户'	=> array(
	    		...
	    		'管理员管理' => array(
	    			"添加管理员"	=>	U('admin/User/addadmin'),
	    			"管理员列表"	=>	U('admin/User/adminlist'),
	    		),
		),
		'communication'	=> array(
	    		'通讯录管理' => array(
	    			"添加通讯录"	=>	U('member/Admin/index'),
	    			"通讯录列表"	=>	U('member/Admin/index'),
	    		),
		),
    )
);
